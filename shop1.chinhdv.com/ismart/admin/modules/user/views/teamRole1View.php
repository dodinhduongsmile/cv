    ...
    <div class="wrap clearfix">
        <div class="section" id="title-page">
                <div class="clearfix">
                    ...
                    <h3 id="index" class="fl-left">Nhóm người quản trị</h3>
                </div>
            </div>
                        ...
                        <table class="table list-table-wp">
                            ...
                            <tbody>
                                <?php
                                        ...
                                        foreach($list_user_admin as $item){
                                        $info_role = array(
                                ...
                                <tr>
                                    ...
                                    <td class="clearfix">
                                        <div class="tb-title fl-left">
                                           <a href="?mod=user&action=edit&id=<?php echo $item['user_id']; ?>" title="chi tiết"><?php echo $item['username']; ?></a>
                                        </div>

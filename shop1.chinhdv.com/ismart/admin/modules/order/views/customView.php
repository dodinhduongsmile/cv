                ...
                <div class="section-detail">
                    <div class="filter-wp clearfix">
                        <ul class="post-status fl-left">
                            <li class="all"><a href="">Tất cả <span class="count">(<?php echo num_rows('tbl_checkout');  ?>)</span></a></li>
                        </ul>
                        <form action="?mod=order&action=search" method="POST" class="form-s fl-right">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul class="list-operation fl-right">
                                            ...
                                            <li><a href="?mod=order&action=deletecustom&id=<?php echo $item['id']; ?>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>

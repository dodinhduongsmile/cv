    ...
    datatables_columns = [{
        ...
        template: function (t) {
            var e = {
                ...
                2: {title: "khôi phục", class: "m-badge--danger"}
            };
            return '<span data-field="is_status" data-value="'+(t.is_status == 2 ? 1 : 0)+'" class="m-badge ' + e[t.is_status].class + ' m-badge--wide btnUpdateField">' + e[t.is_status].title + "</span>";
        }
    }, {
        field: "action",
        width: 250,

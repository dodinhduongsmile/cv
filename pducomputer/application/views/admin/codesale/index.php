                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input name="code" placeholder="mã coupon" class="form-control" type="text" />
                                        </div>
                                        <div class="form-group">
                                            <label>percent</label>
                                            <input name="percent" placeholder="số tiền giảm" class="form-control" type="number" />
                                        </div>
                                        <div class="form-group">
                                            <label>Điều kiện áp dụng</label>
                                            <input name="price_condition" placeholder="đơn hàng >= 100k" class="form-control" type="number" />
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="m-input">
                                                <select class="form-control m-input m-input--square" name="pay_method">
                                                    <option value="1" selected="selected">COD</option>
                                                    <option value="2">Banking</option>
                                                    <option value="3">Theo điểm thưởng</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group">

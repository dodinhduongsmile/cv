                            ...
                            <div class="tab-pane" id="tab_info" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="grouppdu col-lg-12 col-12">
                                        ...
                                        <div class="listclassify" id="listclassify">
                                            <div class="m-section">
                                                <div class="m-section__content">
                                                    <table class="table table-bordered m-table m-table--border-brand m-table--head-bg-brand groupprice">
                                                        <thead>
                                                            <tr>
                                                                <th>
                                                                    #Màu sắc
                                        ...
                                        <input type="hidden" name="classify" value="" id="groupclassify">
                                    </div>
                                </div>
                            </div>

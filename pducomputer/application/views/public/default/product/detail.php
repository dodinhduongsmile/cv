              ...
              <div class="wrapper">
                <div class="inner">
                    <div class="grid product-single" >
                      <div class="grid__item large--five-twelfths medium--one-whole small--one-whole wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.75s">
                        <div class="product-single__photos" >
                           <?php if (!empty($oneItem->album)): 
                                $album = json_decode($oneItem->album);
                            ?>
                          <div id="ProductPhoto" class="owl-carousel owl-theme" data-slide="1" data-pagination="false" data-nav="true">
                            <?php foreach ($album as $value): ?>
                            <div class="item" >
                              <div class="tile" data-scale="2.4" data-src="<?php echo MEDIA_URL.$value; ?>">
                                <div class="photo"></div>
                              </div>
                            </div>
                            <?php endforeach; ?>
                            <!-- item video -->
                            <div class="item" >
                              <img class="lazyloadvideo" src="<?php echo $this->templates_assets.'images/playvideo.jpg'; ?>" data-videopdu="<?php echo $oneItem->video; ?>"/>
                              <div class="iframevideo"></div>
                            </div>
                          </div>
                        <?php endif; ?>
                        </div>
                        <ul class="product-single__thumbnails inline-list" id="ProductThumbs"  data-nav="false">
                          <div class="inner">
                            ...
                            <li class="thumbnail-item">
                              <a href="" class="product-single__thumbnail"  data-pos="<?php echo $i; ?>">
                            ...
                            <!-- video -->
                            <li class="thumbnail-item">
                              <a href="" class="product-single__thumbnail"  data-pos="36">
                              <img class="lazyloadvideo" src="<?php echo $this->templates_assets.'images/playvideo.jpg'; ?>" data-videopdu="<?php echo $oneItem->video; ?>" alt="">
                              </a>
                            </li>
                          </div>
                      ...
                      <style>
                        .photo{position:absolute;top:0;left:0;width:100%;height:100%;background-repeat:no-repeat;background-position:center;background-size:cover;-webkit-transition:-webkit-transform 1s ease-out;transition:-webkit-transform 1s ease-out;-o-transition:transform 1s ease-out;transition:transform .5s ease-out;transition:transform 1s ease-out,-webkit-transform 1s ease-out;cursor:-webkit-zoom-in;cursor:zoom-in;background-size: 100%;}#ProductPhoto .item{width:100%;height:480px}#ProductPhoto .item .tile{width:100%;height:100%}.iframevideo{width:100%;height:100%}.iframevideo iframe{width:100%;height:100%}
                      </style>
<script>
jQuery(document).ready(function ($) {
  $(".lazyloadvideo").on('click', function (event) {

    $(".iframevideo").html('<iframe src="' + $(this).attr('data-videopdu') + '"></iframe>');
    $(".iframevideo").prev().remove();
  });

  var hover = "ok";
  var elm_tar = $('#ProductPhoto .item .tile');
  ...
  elm_tar.on('mouseover', function () {
    $(this).children('.photo').css({
      'transform': 'scale(' + $(this).attr('data-scale') + ')'
    });
  });
  elm_tar.on('mouseout', function () {
    $(this).children('.photo').css({
      'transform': 'scale(1)'
    });
  });
  elm_tar.on('mousemove', function (e) {
    $(this).children('.photo').css({
      'transform-origin': ((e.pageX - $(this).offset().left) / $(this).width()) * 100 + '% ' + ((e.pageY - $(this).offset().top) / $(this).height()) * 100 + '%'
                      ...
                      <div class="grid__item large--seven-twelfths medium--one-whole small--one-whole wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="0.75s">

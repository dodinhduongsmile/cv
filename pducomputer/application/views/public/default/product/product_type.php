                  ...
                  <div class="wrapper">
                     <div class="inner text-center">
                        ...
                        <div class="breadcrumb-small">
                            ...
                            <span><a href="<?php echo get_url_product_type($oneItem); ?>" title="laptop"><?php echo $oneItem->title; ?></a></span>
                        </div>
                     </div>
                  </div>
               </div>
                                                ...
                                                <button class="accordion cs-title col-sb-trigger">
                                                 ...
                                                 <div class="panel sidebar-sor">
                                                    <ul class="list-brand-check">
                                                       ...
                                                       <li><h3><a href="<?php echo get_url_product_type($value); ?>" title="<?php echo $value->title; ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> <?php echo $value->title; ?></a></h3></li>
                                                       <?php endforeach; ?>
                                                    </ul>
                                                </div>
                                            </div>
                                    ...
                                    <div class="collection-head">
                                       ...
                                       <div class="collection-desc">
                                        <ul class="list-chidren">
                                                <?php if (!empty($list_child)) foreach ($list_child as $key => $value) : ?>

                                                <li><a href="<?php echo get_url_product_type($value); ?>" title="<?php echo $value->title ?>"><?php echo $value->title ?></a></li>
                                                <?php endforeach; ?>
                                            </ul>
                                       </div>
                                    </div>
...
<script>
   var url_pagition = "<?php echo base_url('/product/ajaxpaginationtype/'); ?>";

...
class Warehouse_1 extends Admin_Controller
{
    protected $_data;
    ...
    public function index(){
        $data['heading_title'] = "Quản lý nhà cung cấp";
        $data['heading_description'] = "Danh sách nhà cung cấp";
    ...
    public function ajax_list(){
        ...
        $params = [
            'page'          => $page,
            'limit'         => $limit,
            'type_img' => 'warehouse1'//chỉ dùng được type_img vì nó là biến khai báo ở hàm _where_before()
        ];
...
//load nhà cung cấp
    ...
    public function ajax_add(){
        ...
        if($id = $this->_data->save($data)){
            $note   = 'Thêm warehouse_1 có id là : '.$id;
            $this->addLogaction('warehouse_1',$data,$id,$note,'Add');
    ...
    public function ajax_update(){
        ...
        if($this->_data->update(['id' => $id],$data, $this->_data->table)){
            $note   = 'Update warehouse_1 có id là : '.$id;
            $this->addLogaction('warehouse_1',$data_old,$id,$note,'Update');
            $message['type'] = 'success';

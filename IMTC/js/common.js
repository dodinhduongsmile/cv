...
$(function() {
    ...
    navDropdownToggle.on('click', function() {
        ...
        if(!$(this).children('.nav-dropdown').is(":visible"))
        {
...
$(function(){
    $('.application dl dt').click(function () {
        $('.application').find('.index_usee:eq(' + $(this).index() + ')').addClass('index_usee_x').siblings().removeClass('index_usee_x');
        $(this).addClass('index_use_qh').siblings().removeClass();
    });
});